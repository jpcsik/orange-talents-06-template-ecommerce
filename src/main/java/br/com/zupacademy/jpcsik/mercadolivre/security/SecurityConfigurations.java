...
import br.com.zupacademy.jpcsik.mercadolivre.security.token.AutenticacaoViaTokenFilter;
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
				...
				.antMatchers(HttpMethod.GET, "/produto/detalhar/**")
					.permitAll()
				.antMatchers(HttpMethod.POST, "/retorno-pagseguro/**")
					.permitAll()
				.antMatchers(HttpMethod.POST, "/notas-fiscais")
					.permitAll()
				.antMatchers(HttpMethod.POST, "/ranking")
					.permitAll()
